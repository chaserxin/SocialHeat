...
public class GsddBaiduDao implements DaoInterface {
	...
	public static void main(String[] args) {
		...
		// long endTime = 0L;
		// try {
		// startTime = Long.parseLong(TimeUtil.date2Timestamp("2016-7-13
		// 10:00:01"));
		// endTime = Long.parseLong(TimeUtil.date2Timestamp("2016-7-19
		// 23:59:59"));
		// } catch (Exception e1) {
		// e1.printStackTrace();
		// }
		...
		// 获取数据库连接
		Connection conn = DaoHandler.getConnection();
		String sql1 = "SELECT text, create_time FROM gsdd_baidu WHERE create_time LIMIT 0, 3000000";
		String sql2 = "insert into sw_gsdd_baidu(word,create_time) values(?,?)";
